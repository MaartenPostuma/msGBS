...
def make_separate_lists(args):
    ...
    out_handle = open('%s/Eukaryota_ref.fa' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_flowering_plants.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_Bactria.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_AM_Fungi.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_other_Fungi.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_Archaea.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Ref_Virus.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/EUKARYOTA_NAMES.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/BACTERIA_NAMES.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/AM_FUNGI_NAMES.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/OTHER_FUNGI_NAMES.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Archaea_NAMES.txt' % args.directory, 'w')
    teller =0
    ...
    out_handle = open('%s/Virus_NAMES.txt' % args.directory, 'w')
    teller =0
